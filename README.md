...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/Er-Fenil-pethani/3d-portfolio)

![Portfolio Preview](https://github.com/Er-Fenil-pethani/Portfolio/blob/main/public/assets/projects-screenshots/portfolio/landing.png?raw=true)
...
1. **Clone the repository:**
    ...
    ```bash
    git clone https://github.com/Er-Fenil-pethani/3d-portfolio.git
    cd 3d-portfolio
    ```
...
If you use this portfolio, a credit or link back to the [original repo](https://github.com/Er-Fenil-pethani/3d-portfolio) would be much appreciated ❤️
